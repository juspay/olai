Feature: Chat remains usable as the plugin runtime changes
  ...
  @scratch:chat @rows:vault,chat,ws,web-app,mcp,ui-renderer,layout,sidebar,preferences,theme,plugin-inspector,navigation,outlines,markdown,files,pins,capture,trash,vault-plugins
  ...
  @scratch:chat @rows:vault,chat,claude,ws,web-app,mcp,ui-renderer,layout,sidebar,preferences,theme,plugin-inspector,navigation,outlines,markdown,files,pins,capture,trash,vault-plugins
