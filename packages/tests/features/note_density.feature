...
Feature: Note density
  ...
  full markdown is the node's own zoomed page and a click-to-unfold on the
  preview, and a per-view switch picks full / first-line / hidden.
  ...
  Scenario: Clicking the preview unfolds the full note
