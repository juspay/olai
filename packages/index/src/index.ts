 ...
 * https://github.com/juspay/oss.olai/blob/main/olai/brainstorming/search-index.md.
 *
...
export interface Index {
   ...
   * https://github.com/juspay/oss.olai/blob/main/olai/brainstorming/search-index.md) and this implementation put it in
