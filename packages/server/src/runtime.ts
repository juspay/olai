...
export const writerAt = (bound: Pick<Bound, "handlers" | "writes">, _ops: unknown, caller: { readonly writer: string; readonly door?: unknown }): SurfaceHandlers => authorityAt(bound, caller)
