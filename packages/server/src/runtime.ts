 ...
 * every outline in the browser (`https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`
  ...
  Effect.gen(function*() {
    ...
    const deps: ImplementSurfaceDeps<typeof surface.spec> = {
      ...
      streams: {
         ...
         * `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md` was written for, and three
         ...
         * landed (https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/filter-rides-the-page.md).
         *
