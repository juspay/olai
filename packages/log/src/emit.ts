 ...
 * work: the minimum level the operator asked for with the live minimum level, the
 ...
 * the live debug level the operator selected would silently not apply to exactly
