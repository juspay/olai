/**
 * THE APP'S CLOCK, as the header's shortlist reads it — held for the activation that declared
 * it.
 *
 ...
 * `ui-renderer.clocks` — declared on `../browser.tsx`'s `clock` component.
 *
...
/** Told by `../browser.tsx`'s `clock` component, for that activation. */
