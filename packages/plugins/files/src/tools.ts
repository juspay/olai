 ...
 * still offered an agent a `delete_file` nothing stood behind. A tool leaves
 ...
 * set's. `untrash_node` puts a record back; nothing spells a file back. What a
 * `delete_file` call can refuse YOU against is as long as what it can do, which
