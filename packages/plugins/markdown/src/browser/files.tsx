/**
 * THE FILE CONTROLS a document page DRAWS — held for the activation that declared them.
 *
 ...
 *
 * A COMPONENT AND NOT THIS ROW: a document with no files row mounted is a whole document, with no delete verb under it and no minting box — which is what the empty read below
