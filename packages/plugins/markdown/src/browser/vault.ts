/**
 * THE SERVED DIRECTORY, as a document reads it — held for the activation that
 * declared it.
 *
 * The membership and the per-file revision are `olai-plugin-vault`'s, and they
 * arrive on `vault.files` — a service its `content` component already names. They used to
