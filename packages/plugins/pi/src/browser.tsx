/**
 * THE PI ENGINE'S BROWSER HALF — its mark and its inspector row.
 *
 ...
 * the absence reason, including which of pi's two prerequisites is missing.
...
export default definePlugin({
  ...
  needs: [Slots],
  apply: Effect.gen(function*() {
    yield* (yield* Slots).register("delivery.mark", PiMark)
  }),
})
