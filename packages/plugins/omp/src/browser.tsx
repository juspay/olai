/**
 * THE OH-MY-PI ENGINE'S BROWSER HALF — two faces, and both are a drawing ABOUT
 * this engine.
 *
 ...
 * that row says this engine's `name` — **Oh My Pi** — which the server sends
 * exactly as `install.ts` spells it, and core drawing a string it was handed
 * spells nothing.
 *
 ...
 *
 * Nothing. This module is evaluated only when the roster names `omp`: its
 ...
 * a policy selecting only claude, opencode is a tab with none of them in it, in the same sense
...
export default definePlugin({
  ...
  apply: Effect.gen(function*() {
    ...
    // another's name.
    yield* slots.register("delivery.mark", OmpMark)
