/**
 * OH MY PI'S MARK — a bolt, which is what the name is a shout of and what tells
 * it apart from a burst, a knot, a prompt and a letter at a glance.
 *
 * ## Why it is in this package
 *
 * It was a `MARKS` record inside `@olai/web`, keyed by engine id, with the
 ...
 * another engine's shape: Claude's is an eight-point burst and pi's is a letter,
 * so a reader who learns "the burst means Claude" would be told something false
 * the first time it turned up on somebody else's row.
 *
...
export const OmpMark = (): JSX.Element => (
  <g stroke="currentColor" stroke-width="1.6" stroke-linejoin="round" fill="none">
    <path d="M 9.6 2 L 4 9.1 h 3.3 l -1 4.9 L 12 6.9 H 8.7 z" />
  </g>
)
