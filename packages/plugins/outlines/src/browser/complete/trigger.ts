 ...
 * (https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/reactivity-after-the-flip.md §4.3).
 *
...
export { written, type Written } from "@olai/markdown-ui/insert.ts"
