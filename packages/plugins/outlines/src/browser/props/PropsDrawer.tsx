 ...
 * a lane node read as a wall (https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/props-ui.html, drawn after the
...
import type { Entry } from "olai-plugin-outlines/property-values"
...
export function PropsDrawer(props: {
   ...
   * file from the same words on a record at the root, exactly as a relative link
   * and a relative picture already do (`@olai/format`'s `pathedOf`). A default
