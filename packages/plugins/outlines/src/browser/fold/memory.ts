 ...
 * (`https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/vault-in-browser.md` — it may hold at most the page in
...
import { createPreference, parsedJson } from "@olai/web/client/preference.ts"
...
const makePref = () => createPreference(FOLDS_KEY, {
