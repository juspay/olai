 ...
 * second one (`olai-plugin-opencode`) a file rather than a search for the
 * assumptions.
 *
 ...
 * about an agent that is working (`@olai/acp/engine`'s `Leg`'s `queues`).
 *
 ...
 * exactly where they differ (`olai-plugin-opencode`).
 *
