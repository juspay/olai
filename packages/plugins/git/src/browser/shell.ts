/**
 * THE SHELL'S GEOMETRY, as the commit pill reads it — held for the activation that
 * declared it.
 *
 * One reading: whether the viewport is a phone, which is what decides
 * whether the news is a pill in the bar or a banner under it.
 *
