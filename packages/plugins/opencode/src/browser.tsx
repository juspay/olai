/**
 * THE OPENCODE ENGINE'S BROWSER HALF — three faces, and every one of them is a
...
import { OpencodeMark } from "./browser/Mark.tsx"
...
export default definePlugin({
  ...
  apply: Effect.gen(function*() {
    ...
    // another's name.
    yield* slots.register("chat.speaker.mark", OpencodeMark)
