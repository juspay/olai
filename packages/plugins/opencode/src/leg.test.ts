 ...
 * `https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/opencode-chat.md`): call ids of the shape `bash:0` and
...
import { allowedWithoutAsking, OPENCODE, toolNameOf } from "./leg.ts"
