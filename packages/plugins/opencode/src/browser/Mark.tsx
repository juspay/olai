/**
 * OPENCODE'S MARK — a terminal's own two shapes, the prompt chevron and the
 * caret rule, which is what the agent is and what tells it apart from a burst at
 * a glance.
 *
...
export const OpencodeMark = (): JSX.Element => (
  <g
    stroke="currentColor"
    stroke-width="1.6"
