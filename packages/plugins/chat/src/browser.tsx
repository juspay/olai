...
import { keepConversation } from "./browser/agents/holding.ts"
...
export default definePlugin({
  ...
  apply: Effect.gen(function*() {
    ...
    const state = yield* Effect.acquireRelease(Effect.sync(() => createRoot(dispose => {
      ...
      return { dispose, agents, keep: createKeeps(agents, keepConversation), engines: enginesService(agents.missing), readings: createAgentReadings(agents), folding: createFolding() }
