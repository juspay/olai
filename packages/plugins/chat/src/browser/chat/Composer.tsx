 ...
 *     the path of (`olai-plugin-chat`'s attachments) — the right arrangement for a
...
import type { Written } from "@olai/web/client/complete/trigger.ts"
      ...
      case "name":
        ...
        return offers(files(), nodesNamed.hits(), completing.query).map((offer) => ({
          ...
          take: () => {
            ...
            // ancestors under the message (`olai-plugin-chat`'s `lineFor`). Neither
