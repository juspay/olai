...
import { ledgerIntegration, searchIntegration } from "./views.ts"
import http from "./http.ts"
export const components = { "file-access": fileAccess, setup, revalidation, http, "ledger-view": ledgerIntegration, "search-view": searchIntegration }
