 ...
 * (`https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/vault-in-browser.md`). So the fold is gone, the
...
import { sortByPath } from "@olai/web/client/paths.ts"
import { sameMap } from "@olai/web/client/same.ts"
...
export interface Directory {
   ...
   *  (https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/reactivity-after-the-flip.md §4.2).
   *
