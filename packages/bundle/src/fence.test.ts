...
describe("only the registry knows a plugin's name in CODE, too", () => {
  ...
  const NOT_A_PLUGIN: Readonly<Record<string, ReadonlyArray<string>>> = {
    "alerts": [
      ...
      "plugins/chat/src/browser/chat/attention/attention.ts",
      "plugins/journal/src/browser.tsx",
      "plugins/journal/src/browser/reminders/ReminderRow.tsx",
      "plugins/journal/src/browser/reminders/circuit.ts"
    ],
    "chat": [
    ...
    "files": [
      ...
      "plugins/chat/src/chat.ts",
      "plugins/git/src/browser.tsx",
      "plugins/git/src/browser/commit/Panel.tsx",
      "plugins/git/src/browser/commit/selection.ts",
      "plugins/git/src/git/git.ts",
      "plugins/git/src/ledger/pending.bench.ts",
      "plugins/git/src/ledger/pending.ts",
      "plugins/journal/src/browser/dates.ts",
      "plugins/kolu/src/server.ts",
      "plugins/layout/src/Fault.tsx",
      "plugins/markdown/src/browser.tsx",
      ...
      "plugins/navigation/src/pages.ts",
      "plugins/outlines/src/browser.tsx",
      "plugins/outlines/src/browser/NotFound.tsx",
      ...
      "plugins/vault/src/file-access.ts",
      "plugins/vault/src/file-surface.ts",
    ...
    "olai": [
      "acp/src/engine.ts",
      "appearance/src/mark.ts",
      "appearance/src/palettes.ts",
      "appearance/src/scale.ts",
      "appearance/src/sizes.ts",
      "effect-cordis/src/host.ts",
      "effect-cordis/src/loader.ts",
      "fonts/src/typefaces.ts",
      "format/src/committing.ts",
      "format/src/conventions.bench.ts",
      "format/src/dates.bench.ts",
      "format/src/failure.ts",
      "format/src/filter.bench.ts",
      "format/src/index.ts",
      "format/src/message.ts",
      "format/src/node.ts",
      ...
      "markdown-ui/src/anchors.ts",
      "markdown-ui/src/lit.ts",
      "markdown-ui/src/tags.ts",
      "ops/src/documents.bench.ts",
      "ops/src/encode.ts",
      "ops/src/plan.ts",
      "ops/src/standing.bench.ts",
      "ops/src/walks.bench.ts",
      "plugin-api/src/authority.ts",
      "plugin-api/src/configuration.ts",
      "plugin-api/src/mount.ts",
      "plugin-build/src/bind.ts",
      "plugin-build/src/imports.ts",
      "plugin-build/src/shared.ts",
      "plugins/alerts/src/badge.ts",
      "plugins/alerts/src/chime.ts",
      "plugins/alerts/src/keys.ts",
      "plugins/capture/src/tools.ts",
      "plugins/chat/src/adapter.ts",
      "plugins/chat/src/agent.ts",
      "plugins/chat/src/attachments.ts",
      "plugins/chat/src/browser/agents/Door.tsx",
      "plugins/chat/src/browser/agents/Unassigned.tsx",
      "plugins/chat/src/browser/chat/Choose.tsx",
      "plugins/chat/src/browser/chat/Entry.tsx",
      "plugins/chat/src/browser/chat/NoAgent.tsx",
      "plugins/chat/src/browser/chat/Preview.tsx",
      "plugins/chat/src/browser/chat/Roster.tsx",
      "plugins/chat/src/browser/chat/ToolFrame.tsx",
      "plugins/chat/src/browser/chat/Transcript.tsx",
      "plugins/chat/src/browser/chat/Unopened.tsx",
      "plugins/chat/src/browser/chat/Wake.tsx",
      "plugins/chat/src/browser/chat/attention/notice.ts",
      "plugins/chat/src/browser/chat/attention/watching.ts",
      "plugins/chat/src/browser/wire.ts",
      "plugins/chat/src/chat.ts",
      "plugins/chat/src/fixtures/stale-session-agent.ts",
      "plugins/chat/src/server.ts",
      "plugins/chat/src/teaching.ts",
      "plugins/claude/src/install.ts",
      "plugins/claude/src/server.ts",
      "plugins/codex/src/install.ts",
      "plugins/codex/src/server.ts",
      "plugins/files/src/Files.tsx",
      "plugins/files/src/contracts/icons.tsx",
      "plugins/files/src/contracts/kinds.ts",
      "plugins/files/src/file/delete.ts",
      "plugins/files/src/fold/folders.ts",
      "plugins/files/src/tools.ts",
      "plugins/git/src/browser/commit/Panel.tsx",
      "plugins/git/src/browser/commit/said.ts",
      "plugins/git/src/browser/wire.ts",
      "plugins/git/src/git/git.ts",
      "plugins/git/src/ledger/message.ts",
      "plugins/git/src/ledger/pending.bench.ts",
      "plugins/git/src/ledger/pending.ts",
      "plugins/git/src/tools.ts",
      "plugins/identity/src/browser/viewer/asking.ts",
      "plugins/journal/src/browser/calendar/Calendar.tsx",
      "plugins/journal/src/browser/reminders/notice.ts",
      "plugins/journal/src/browser/reminders/said.ts",
      "plugins/kolu/src/appliance/padi/said.ts",
      "plugins/kolu/src/appliance/props/LivePane.tsx",
      "plugins/kolu/src/appliance/props/fleet.tsx",
      "plugins/kolu/src/appliance/props/terminal.ts",
      "plugins/kolu/src/client/index.ts",
      "plugins/kolu/src/client/link.ts",
      "plugins/kolu/src/client/mirror.ts",
      "plugins/kolu/src/client/screen.ts",
      "plugins/kolu/src/client/testlib/padi.ts",
      "plugins/kolu/src/client/wire/kolu.ts",
      "plugins/kolu/src/doorbell.ts",
      "plugins/kolu/src/wake.ts",
      "plugins/layout/src/Fault.tsx",
      "plugins/layout/src/Header.tsx",
      "plugins/layout/src/browser.tsx",
      "plugins/layout/src/layout/prefs.ts",
      "plugins/markdown/src/assets.ts",
      "plugins/markdown/src/browser/EmbeddedDocument.tsx",
      "plugins/markdown/src/browser/document/DocRef.tsx",
      "plugins/markdown/src/browser/document/Hypertext.tsx",
      "plugins/mcp/src/endpoint.ts",
      "plugins/mcp/src/tickets.ts",
      "plugins/navigation/src/palette/Palette.tsx",
      "plugins/navigation/src/palette/items.ts",
      "plugins/navigation/src/routes.ts",
      "plugins/odu/src/appliance/resolve.ts",
      "plugins/odu/src/appliance/runs.ts",
      "plugins/odu/src/doorbell.ts",
      "plugins/odu/src/probe.ts",
      "plugins/odu/src/server.ts",
      "plugins/odu/src/wake.ts",
      "plugins/outlines/src/browser/NodeBody.tsx",
      "plugins/outlines/src/browser/NodeLine.tsx",
      "plugins/outlines/src/browser/Note.tsx",
      "plugins/outlines/src/browser/OutlinePage.tsx",
      "plugins/outlines/src/browser/Tree.tsx",
      "plugins/outlines/src/browser/date/repeat.ts",
      "plugins/outlines/src/browser/edit/point.ts",
      "plugins/outlines/src/browser/focus.ts",
      "plugins/outlines/src/browser/fold/memory.ts",
      "plugins/outlines/src/browser/fold/refiling.ts",
      "plugins/outlines/src/browser/menu/picking.ts",
      "plugins/outlines/src/browser/overlay.ts",
      "plugins/outlines/src/contracts/preferences.ts",
      "plugins/outlines/src/tools.ts",
      "plugins/pi/src/install.ts",
      "plugins/pi/src/server.ts",
      "plugins/plugin-inspector/src/Panel.tsx",
      "plugins/preferences/src/Panel.tsx",
      "plugins/search/src/table.bench.ts",
      "plugins/search/src/tools.ts",
      "plugins/settings/src/policy.ts",
      "plugins/sidebar/src/Rail.tsx",
      "plugins/sidebar/src/Sidebar.tsx",
      "plugins/test-layout/src/browser.tsx",
      "plugins/theme/src/assets.ts",
      "plugins/trash/src/browser/question.ts",
      "plugins/trash/src/tools.ts",
      "plugins/vault-plugins/src/route.ts",
      "plugins/vault-plugins/src/runtime.ts",
      "plugins/vault-plugins/src/tools.ts",
      "plugins/vault/src/file-kinds.ts",
      "plugins/vault/src/format.ts",
      "plugins/vault/src/http/media.ts",
      "plugins/vault/src/http/resync.ts",
      "plugins/vault/src/lock.ts",
      "plugins/vault/src/server/bodies.ts",
      "plugins/vault/src/views.ts",
      "plugins/xyne-spaces/src/browser/said.ts",
      "plugins/xyne-spaces/src/client.ts",
      "plugins/xyne-spaces/src/mirror.ts",
      "plugins/xyne-spaces/src/server.ts",
      "plugins/xyne-spaces/src/wire.ts",
      "server/src/allowedOrigins.ts",
      "server/src/clientDist.ts",
      "server/src/configuration.ts",
      "server/src/dial.ts",
      "server/src/dieWithParent.ts",
      "server/src/hostname.ts",
      "server/src/main.ts",
      "server/src/mcpClient.ts",
      "server/src/process-policy.ts",
      "server/src/serve.ts",
      "server/src/who.ts",
      "sigterm/src/sigterm.ts",
      "state/src/index.ts",
      ...
      "surface/src/who.ts",
      "web/src/build.ts",
      "web/src/client/preference.ts",
      "web/src/client/wire.ts",
      "web/src/host/loading.ts",
      "web/src/host/runtime.ts"
    ],
    "markdown": [
      "appearance/src/scale.ts",
      "edit-intents/src/index.ts",
      ...
      "plugins/files/src/contracts/icons.tsx",
      "plugins/files/src/contracts/kinds.ts",
      "plugins/files/src/file/making.ts",
      "plugins/files/src/tools.ts",
      "plugins/journal/src/server.ts",
    ...
    "hypertext": [
      ...
      "plugins/markdown/src/browser/document/Hypertext.tsx",
      "plugins/markdown/src/browser/document/faces.tsx",
      "plugins/markdown/src/testids.ts"
    ],
    "csv": [
      "format/src/csv.ts",
      "format/src/index.ts",
      ...
      "plugins/files/src/testids.ts",
      "plugins/files/src/tools.ts",
      "plugins/markdown/src/browser/document/Csv.tsx",
      "plugins/markdown/src/browser/document/clamped.ts",
      "plugins/markdown/src/browser/document/faces.tsx",
      "plugins/markdown/src/testids.ts",
      "surface/src/attach.ts"
    ],
    "image": [
      "format/src/documents.ts",
      "plugin-kit/src/mark/inline.ts",
      "plugins/chat/src/agent.ts",
      "plugins/chat/src/browser/chat/Attachments.tsx",
      "plugins/chat/src/browser/chat/Composer.tsx",
      "plugins/chat/src/browser/chat/attach.ts",
      "plugins/files/src/contracts/icons.tsx",
      "plugins/files/src/contracts/kinds.ts",
      "plugins/files/src/testids.ts",
      "plugins/kolu/src/client/testlib/fake-padi.ts",
      "plugins/markdown/src/browser/document/Image.tsx",
      "plugins/markdown/src/browser/document/faces.tsx",
      "plugins/markdown/src/testids.ts",
      "plugins/theme/src/chrome.ts",
      "plugins/vault/src/http/media.ts",
    ...
    "pdf": [
      ...
      "plugins/files/src/testids.ts",
      "plugins/files/src/tools.ts",
      "plugins/markdown/src/browser/document/Pdf.tsx",
      "plugins/markdown/src/browser/document/faces.tsx",
      "plugins/markdown/src/testids.ts",
      "surface/src/attach.ts"
    ]
