/**
 * The file table and the derivation name the same faces.
 *
 * `default.nix` converts a list of nixpkgs files; `hosted.ts` names the files
 ...
 * by-name lookup fails (a face the table gained) — or forever (a face the
...
test("the derivation converts exactly the files the table hosts", () => {
