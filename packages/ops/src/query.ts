 ...
 * it can express are the things the format can be (https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/acp.md,
 ...
 * (https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/surface-mcp-positions.md).
 *
 ...
 * file's header names them and https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/filter-in-place.md argues it.
 *
 ...
 * size of a page (https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/filter-rides-the-page.md).
 *
 ...
 * browser out of a copy of the set (`https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`
 ...
 * copy `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md` is taking away. Nothing about
 ...
 * (`https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`: the browser may hold at most the
 ...
 * https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/model-indices.md names, arriving here first.
 */
const placementsOf = (
  derived: Derived,
  id: string,
