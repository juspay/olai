 ...
 * `doing:` / `move:` / `archive:` / `create:` and the node's title (or a path,
 * when an outline is born empty) — because a log a person already knows how to
 * read is worth more than a better one they do not.
 *
