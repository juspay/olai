...
export interface Scope extends Reading {
   ...
   * (https://github.com/juspay/oss.olai/blob/main/olai/brainstorming/typed-properties.md: births are gated too).
   *
...
const emit = (
  ...
  // here (https://github.com/juspay/oss.olai/blob/main/olai/brainstorming/typed-properties.md: births are gated too).
