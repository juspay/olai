 ...
 *
 * The BUILDERS for outlines as text come from `@olai/format/testlib`, put
 * through the real `parseOutline` and `assemble`. A repository around a
 * directory is the git plugin's (`olai-plugin-git/testlib`); this package
 * holds no git.
 *
