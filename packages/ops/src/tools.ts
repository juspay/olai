...
export interface Asking {
  ...
  /** The one question every door asks — `search_nodes` for an agent, and\n   *  every picker in the browser (`@olai/web`\x27s `search/nodes.ts`). */
  readonly search: (
