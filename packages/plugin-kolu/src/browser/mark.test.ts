...
const guard = (): void => {
  if (!existsSync(GENERATED)) {
    throw new Error(
      "packages/plugin-kolu/src/browser/mark.generated.ts is absent. It is GENERATED from " +
        "the pinned kolu's packages/client/favicon.svg by packages/plugin-kolu/default.nix " +
