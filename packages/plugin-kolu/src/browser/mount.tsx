 ...
 *
 * `@olai/kolu-ui`'s `KoluUi` is unchanged and does the work: it binds the three
 ...
 *
 *   - the CLIENT, narrowed once at this edge. `@olai/plugins` types a mount's
...
import type { KoluClient } from "@olai/kolu-ui"
