 ...
 *     the browser no longer holds one (`https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`);
 ...
 * one title, and it is what PR 10 of `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`
