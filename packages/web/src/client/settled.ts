 ...
 * (`https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/reactivity-after-the-flip.md`'s 4.12, and the deferral
 * it left behind).
 *
...
export interface Settled<Q, A> {
   ...
   * `https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/reactivity-after-the-flip.md`). It is compared
