 ...
 * read-only. The sentence they lean on — who set this, and that a browser
 * cannot — is `../settings/instance.ts`.
 *
 ...
 *
 * **PURE FUNCTIONS OF THE CELL, and nothing else.** There is no state here, no store, and no
