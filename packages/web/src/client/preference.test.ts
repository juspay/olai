...
test("no client file outside this module spells the circuit's read or watch", () => {
  // The appearance provider now owns its explicit HTML/storage circuit in its
  // own package. Remaining web preferences use this shared factory.
