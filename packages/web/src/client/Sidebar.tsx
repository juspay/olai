 ...
 * It wears Agenda's own count badge: how many rows of the inbox are marked
 * `todo` or `doing`, at any depth, hidden at zero. **Trash** stays at the foot, below the tree, because
