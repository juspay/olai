 ...
 * URL says (see ./page.ts). An entry is marked when its file could not be
 * read: the rest of the directory is still live, and which one is broken is
 * something a reader should be able to see without opening it.
 */
