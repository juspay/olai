 ...
 * pane.
 *
 * This is the browser's half of `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`'s PR
...
export interface Reading {
   ...
   * not have — see https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/filter-rides-the-page.md.
   *
   ...
   * (https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/reactivity-after-the-flip.md §3.6). So the count was
   ...
   * closes (`https://github.com/juspay/oss.olai/blob/master/olai/roadmap/deferred.olai`'s `names-table-once`).
   */
...
export const createReading = (
   ...
   * (https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/reactivity-after-the-flip.md §3.1: the folder chain
