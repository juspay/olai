  ...
  return (
    ...
    <Editable rows={() => props.rows} file={props.file} within={[]}>
      ...
      {/* An outline that holds nothing still has to be startable, and a tree
          of no rows offers nowhere to press a key. Asked of the FILE rather
          than of the reading (`holds`, above): rows can also be missing
          because this page is hiding what is done — or because a FILTER
          matched nothing — and "write its first line" would be a lie over a
          tree that is one pick from coming back. The filter bar says what
