...
export function DoneToggle(
  ...
  return (
    <button
      ...
      class={`inline-flex ${TARGET} shrink-0 cursor-pointer items-center rounded-full border border-transparent bg-pill px-4 py-1 text-xs text-muted hover:text-ink md:min-h-0 md:px-3`}
