...
export function Palette(props: {
   ...
   * (https://github.com/juspay/oss.olai/blob/main/olai/brainstorming/reactivity-after-the-flip.md §4.6). `createSelector`
  ...
  const items = createMemo(() => {
    ...
    // (https://github.com/juspay/oss.olai/blob/main/olai/brainstorming/reactivity-after-the-flip.md §4.5). Solid re-tracks
