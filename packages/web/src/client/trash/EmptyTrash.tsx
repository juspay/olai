 ...
 * of `https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/vault-in-browser.md`; the rule did not move, the set
...
export function EmptyTrash(props: {
   ...
   * `https://github.com/juspay/oss.olai/blob/main/projects/olai/brainstorming/vault-in-browser.md`; the rule did not move, the set
   * did.
   *
