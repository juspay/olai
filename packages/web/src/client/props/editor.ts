 ...
 * omission — the prototype let both boxes be typed in.
 *
 ...
 * since a person's gesture must be an op an agent can make. So the drawer
 * offers exactly what the tool offers: add a property, change what one holds,
 * remove one. A rename is the two of those, in the order the reader chooses.
 */
