 ...
 *  vault `packages/format/src/patch.bench.ts` and `@olai/format`'s `vocabulary.bench.ts`
 *  run on, so what a frame costs a tab, what the patch inside it costs, and what a
