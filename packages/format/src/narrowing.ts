 ...
 * the shape that lost, is https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/filter-rides-the-page.md.
 *
 ...
 * https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/editing-web.md's Open).
 *
