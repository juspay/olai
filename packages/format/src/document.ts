 ...
 * (https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/first-class-documents.md, ruled 2026-08-19). Before it,
 ...
 * (https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/model-indices.md). So the constructors below are what a decode calls, and
