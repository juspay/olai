...
export {
   ...
   *  `created` is never the fallback). The browser's settled chip and the
   *  reads' `took` — `read_node`'s own row and a caller-shaped walk row
   *  alike — are the readers; the doing half of the same
