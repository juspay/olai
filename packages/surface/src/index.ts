 ...
 *     `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md` landing: a tab held every record
 ...
 *     `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md` is going — the browser is handed
 ...
 * `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`. A stream is a CELL WITH AN
 ...
 * `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/reactivity-after-the-flip.md` §2's Fact B. Declared, an
 ...
 * `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/outlines-as-collection.md`. Only the files that MOVED in
 ...
 *
 * EVERY served file since PR 10 of `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`,
...
export const surface = defineSurface({
  cells: {
     ...
     * `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`. Nothing about it depends on who
  ...
  collections: {
     ...
     * `https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md`: the sidebar's tree is these paths, a page model
   ...
   * (`https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/vault-in-browser.md` §2) says what "updates to that" has to mean — "on
  ...
  streams: {
    ...
    page: {
       ...
       * one row (`https://github.com/juspay/oss.olai/blob/master/olai/brainstorming/reactivity-after-the-flip.md`'s 2.11 — the
