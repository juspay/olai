 ...
 *      (`@olai/format`'s `proseIn`, spent by the Markdown page,
 *      the Markdown row’s `browser/document/DocRef.tsx` and the journal row’s `browser/day/DayNote.tsx`), never here.
