# Dev shell — `olai-base.toDevShell` (corepkgs#155 / EEP 0001): the packaged
# build's environment, plus the extra packages and env the justfile legs
# need. Flake.nix passes `olai-base`; `nix develop` is the entry.
{ pkgs, olai-base }:
let
