...
- **A note-only match draws one clamped line** of its note, opening at the hit's own line, with the word lit (`filter/excerpt.ts`). It replaces the density preference's top-of-note preview on that row rather than sitting beside it.
