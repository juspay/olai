...
| Outline text editing | Create, rename, multiline paste, notes, blur/Enter/Escape, IME, rapid input and refused writes | `keyboard_editing`, `native_timing`, `title_markdown`, `note_density` | Fixed characters discarded while a parked row waits for the prior save; immediate-input regression added. Five additional `outline_drafts_lifecycle` scenarios cover skeleton retention, refused drafts, cancellation, explicit navigation and independent phone tabs. Broader editing review open |
