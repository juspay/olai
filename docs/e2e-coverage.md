...
| Dates and journal | Set/clear date and recurrence, complete repeating work, day/agenda navigation and filtering, daily-note creation and edits | `setting_a_date`, `recurring_dates`, `row_forms_lifecycle`, `journal_and_calendar`, `agenda`, `daily_notes` | Fixed unsubmitted date/repeat choices lost on plugin rebuilds and phone pane switches. Six new scenarios cover filtered-page retention, apply, cancellation, explicit navigation, parent collapse and independent phone pane drafts. Pending/refused form submissions and wider date/journal review remain open; journal first activation and route recovery scenarios added |
