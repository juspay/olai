...
A server boot opens no conversation. Stored chats stay asleep until a tab reads one, a wake opens it, or ongoing work holds it live. Reading a node agent opens the session named by its property.
