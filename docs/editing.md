...
An unrelated plugin change keeps the outline's unfinished rows and any refused edit on the page. They can still be filled in, corrected or discarded after the rebuild. Each pane keeps its own drafts, including phone tabs showing the same outline; leaving for another page discards that page's parked rows.
