...
Changing plugins while staying on the document keeps its editor open, with the unsaved text and original conflict baseline intact. Save and Cancel still end that draft; a plugin rebuild never saves it implicitly.
