...
- [running.md](running.md) — how to serve a directory: `olai web` and its flags, one olai per directory, the home-manager module, the HTTP MCP face at `/mcp`, and who is looking behind a reverse proxy.
