...
- [chat.md](chat.md) — the chat agent: which agents olai finds and how a conversation is bound to one, ACP and `OLAI_ACP_AGENT`, the node tools, pictures, being told when the agent is waiting on you, what a conversation wakes on, and kolu.
