...
|------|---------|
| 0 | success |
| 1 | usage: unknown command (`css`, `html`, `agenda`, `calendar` and `ics` are retired), bad flags, missing TITLE, a malformed `--date` / `--port` |
