...
| `chat/scoped.test.ts`: idle and capacity eviction, refused starts, scope state | The refusal being visible in the row menu, the fold opening after start, Needs you/Recent standings, clicking to resume, the rendered transcript, and prompts and questions after recovery |
